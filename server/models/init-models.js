...
const _curriculum_materi = require("./curriculum_materi");
const _curriculum_reviews = require("./curriculum_reviews");
const _instructor = require("./instructor");
const _jobs = require("./jobs");
const _jobs_talent_apply = require("./jobs_talent_apply");
const _placement = require("./placement");
const _roles = require("./roles");
const _talent = require("./talent");
const _talent_batch = require("./talent_batch");
const _talent_experience = require("./talent_experience");
const _talent_experience_media = require("./talent_experience_media");
const _talent_placement = require("./talent_placement");
const _talent_timeline = require("./talent_timeline");
const _time_line = require("./time_line");
const _user_roles = require("./user_roles");
const _users = require("./users");
const _users_client = require("./users_client");
